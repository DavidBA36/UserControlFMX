...
type
  ...
  private
    ...
    FBtOk: String;
    FBtCancel: String;
    FLabelForgetPassword: string;
    FBottomImage: TImageViewer;
    FLeftImage: TImageViewer;
    FTopImage: TImageViewer;
    fLabelTentativas: String;
    fLabelTentativa: String;
    fEmpresa: Integer;
    fRecordar: Boolean;
    fAutoIniciar: Boolean;
    FLocalUser: Boolean;
    // procedure SetFBottomImage(const Value: TImageViewer);
    // procedure SetFLeftImage(const Value: TImageViewer);
    // procedure SetFTopImage(const Value: TImageViewer);
  protected
  ...
  published
    ...
    property LabelForgetPassword: String read FLabelForgetPassword write FLabelForgetPassword;
    property BtOk: String read FBtOk write FBtOk;
    property BtCancel: String read FBtCancel write FBtCancel;
    property Recordar: Boolean read fRecordar write fRecordar;
    property AutoIniciar: Boolean read fAutoIniciar write fAutoIniciar;
    property Empresa: Integer read fEmpresa write fEmpresa;
    property LocalUser: Boolean read FLocalUser write FLocalUser;
    // property TopImage: TImageViewer read FTopImage write SetFTopImage;
    // property LeftImage: TImageViewer read FLeftImage write SetFLeftImage;
    // property BottomImage: TImageViewer read FBottomImage write SetFBottomImage;
  ...
  private
    ...
    FCadGroupFormMSG: TUCCadUserFormMSG;
  ...
  protected
    ...
    procedure SetFCadGroupFormMSG(const Value: TUCCadUserFormMSG);
  ...
  published
    ...
    property GroupsForm: TUCCadUserFormMSG read FCadGroupFormMSG write SetFCadGroupFormMSG;
    ...
    property WindowsPosition: TFormPosition read FPosition write FPosition;
...
begin
  ...
  FPosition := TFormPosition.MainFormCenter;
...
procedure TUCUserSettings.SetFCadGroupFormMSG(const Value: TUCCadUserFormMSG);
begin
  GroupsForm := Value;
end;
